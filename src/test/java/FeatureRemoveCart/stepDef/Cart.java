package FeatureRemoveCart.stepDef;
...
public class Cart {
    ...
    public void user_showing_button_with_text_remove() {
        String success = driver.findElement(By.id("add-to-cart-sauce-labs-backpack")).getText();
        Assert.assertEquals(success, "Add to cart");
    }
